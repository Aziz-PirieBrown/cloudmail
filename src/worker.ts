...
import { api as freemailCompatApi } from './mails_api/freemail_compat'
...
app.use('/api/*', async (c, next) => {
	if (c.req.path.startsWith("/api/new_address")
		|| c.req.path.startsWith("/api/domains")
		|| c.req.path.startsWith("/api/create")
		|| c.req.path.startsWith("/api/generate")
		|| c.req.path.startsWith("/api/emails")
		|| c.req.path.startsWith("/api/email/")
		|| c.req.path.startsWith("/api/mailboxes")
	) {
